...
import com.tplink.seatatest.action.impl.TccActionOneImpl;
import com.tplink.seatatest.action.impl.TccActionTwoImpl;
...
public class LocalTccTransactionStarter {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //plicationContext = new ClassPathXmlApplicationContext(new String[] {"spring/seata-tcc.xml"});

        tccTransactionService = (TccTransactionService) applicationContext.getBean("tccTransactionService"   );

        tccActionOne = (TccActionOneImpl) applicationContext.getBean(TccActionOne.class);
        tccActionTwo = (TccActionTwoImpl) applicationContext.getBean(TccActionTwo.class);
    ...
    private static void transactionRollbackDemo() throws InterruptedException {
        ...
        try{
            ...
            System.out.println("rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr back");
