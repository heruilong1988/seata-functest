...
public class AntiDanglingTryTest extends BaseTest {

    @Test
    void antiDanglingTryTest() {
        String deviceId = "seata_func_test_anti_dangling_try";
        long ownerId = 1;
        long userId = 2;
        ...
        try {
            deviceUserTransactionService.antiDanglingTry(deviceUserInfo);
        }catch (Exception e) {
            e.printStackTrace();
        }
